...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Stock Barang Gudang</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="export_keluar.php" class="btn btn-info">Export Barang Keluar</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM barang_keluar k, stock s WHERE s.id_barang = k.id_barang");
                                        while($data = mysqli_fetch_array($ambilsemuadatastock)){
                                            $idk = $data['id_barang_keluar'];
                                            $idb = $data['id_barang'];
